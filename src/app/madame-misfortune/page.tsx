  ...
  return (
    <>
      <header className={styles.header}>
        ...
        {step === 'choose' && (
          <p>Prepare to learn what you’d rather not know, <br /> begin by picking three cards below...</p>
        )}
        {step === 'reveal' && (
          <p>Three signs of doom from hand you've played, <br /> discover what wicked fate's been laid...</p>
        )}
      </header>
  
      <main className={styles.cards}>
        {step === 'choose' && deck.map(card => (
          <Card
            key={card.id}
            card={card}
        ...
        {step === 'reveal' && (
          <p>Your fate's been sealed, no need to scream, <br />
          nor to pray – misfortune loves to lead the way.</p>
        )}
      </main>
    </>
  );
